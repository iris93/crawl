...
class Cmbccbank(scrapy.Spider):
    ...
    def start_requests(self):
        myformdata = {
            'request':'{\"body\":{\"page\":\"1\",\"row\":\"10\"},\"header\":{\"device\":{\"model\":\"SM-N7508V\",\"osVersion\":\"4.3\",\"imei\":\"352203064891579\",\"isRoot\":\"1\",\"nfc\":\"1\",\"brand\":\"samsung\",\"mac\":\"B8:5A:73:94:8F:E6\",\"uuid\":\"45cnqzgwplsduran7ib8fw3aa\",\"osType\":\"01\"},\"appId\":\"1\",\"net\":{\"ssid\":\"oa-wlan\",\"netType\":\"WIFI_oa-wlan\",\"cid\":\"17129544\",\"lac\":\"41043\",\"isp\":\"\",\"ip\":\"195.214.145.199\"},\"appVersion\":\"3.60\",\"transId\":\"Financialpage\",\"reqSeq\":\"0\"}}'
        }
        for i in range(1,2):
            curpage = i
